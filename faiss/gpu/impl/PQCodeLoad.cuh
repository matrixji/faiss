...
#else
        code32[0] = ((unsigned int)p[1] << 8) | p[0];
#endif
    }
};
...
#else
        code32[0] = *reinterpret_cast<uint32_t*>(p);
#endif
    }
};
...
struct LoadCode32<8> {
    ...
    *pcode32 = *reinterpret_cast<uint2*>(p);
#endif
    }
};
...
#else
        code32[0] = *reinterpret_cast<uint32_t*>(p);
        code32[1] = *reinterpret_cast<uint32_t*>(p + 4);
        code32[2] = *reinterpret_cast<uint32_t*>(p + 8);
#endif
    }
};
...
struct LoadCode32<16> {
    static inline __device__ void load(
        ...
        *pcode32 = *reinterpret_cast<uint4*>(p);
#endif
    }
};
...
struct LoadCode32<20> {
    static inline __device__ void load(
        ...
        code32[1] = *reinterpret_cast<uint32_t*>(p + 4);
        code32[2] = *reinterpret_cast<uint32_t*>(p + 8);
        code32[3] = *reinterpret_cast<uint32_t*>(p + 12);
        code32[4] = *reinterpret_cast<uint32_t*>(p + 16);
#endif
    }
};
...
struct LoadCode32<24> {
    static inline __device__ void load(
        ...
        uint2* pcode32 = reinterpret_cast<uint2*>(code32);
        *pcode32 = *reinterpret_cast<uint2*>(p);
        *(pcode32 + 1) = *reinterpret_cast<uint2*>(p + 8);
        *(pcode32 + 2) = *reinterpret_cast<uint2*>(p + 16);
#endif
    }
};
...
struct LoadCode32<28> {
    static inline __device__ void load(
        ...
        code32[3] = *reinterpret_cast<uint32_t*>(p + 12);
        code32[4] = *reinterpret_cast<uint32_t*>(p + 16);
        code32[5] = *reinterpret_cast<uint32_t*>(p + 20);
        code32[6] = *reinterpret_cast<uint32_t*>(p + 24);
#endif
    }
};
...
struct LoadCode32<32> {
    static inline __device__ void load(
        ...
        uint4* pcode32 = reinterpret_cast<uint4*>(code32);
        *pcode32 = *reinterpret_cast<uint4*>(p);
        *(pcode32 + 1) = *reinterpret_cast<uint4*>(p + 16);
#endif
    }
};
...
struct LoadCode32<40> {
    static inline __device__ void load(
        ...
        *(pcode32 + 1) = *reinterpret_cast<uint2*>(p + 8);
        *(pcode32 + 2) = *reinterpret_cast<uint2*>(p + 16);
        *(pcode32 + 3) = *reinterpret_cast<uint2*>(p + 24);
        *(pcode32 + 4) = *reinterpret_cast<uint2*>(p + 32);
#endif
    }
};
...
struct LoadCode32<48> {
    static inline __device__ void load(
        ...
        *pcode32 = *reinterpret_cast<uint4*>(p);
        *(pcode32 + 1) = *reinterpret_cast<uint4*>(p + 16);
        *(pcode32 + 2) = *reinterpret_cast<uint4*>(p + 32);
#endif
    }
};
...
struct LoadCode32<56> {
    static inline __device__ void load(
        ...
        *(pcode32 + 3) = *reinterpret_cast<uint2*>(p + 24);
        *(pcode32 + 4) = *reinterpret_cast<uint2*>(p + 32);
        *(pcode32 + 5) = *reinterpret_cast<uint2*>(p + 40);
        *(pcode32 + 6) = *reinterpret_cast<uint2*>(p + 48);
#endif
    }
};
...
struct LoadCode32<64> {
    ...
    uint4* pcode32 = reinterpret_cast<uint4*>(code32);
        ...
        *(pcode32 + 1) = *reinterpret_cast<uint4*>(p + 16);
        *(pcode32 + 2) = *reinterpret_cast<uint4*>(p + 32);
        *(pcode32 + 3) = *reinterpret_cast<uint4*>(p + 48);
#endif
    }
};
...
struct LoadCode32<96> {
    static inline __device__ void load(
        ...
        *(pcode32 + 2) = *reinterpret_cast<uint4*>(p + 32);
        *(pcode32 + 3) = *reinterpret_cast<uint4*>(p + 48);
        *(pcode32 + 4) = *reinterpret_cast<uint4*>(p + 64);
        *(pcode32 + 5) = *reinterpret_cast<uint4*>(p + 80);
#endif
    }
};
